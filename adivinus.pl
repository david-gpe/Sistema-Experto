...
:-pce_image_directory('C:/Users/gpema/OneDrive/Escritorio/Cursos/Sistema Experto').
:-pce_image_directory('C:/Users/gpema/OneDrive/Escritorio/Cursos/Sistema Experto').
...
perro:- smamifero,
	...
	pregunta('¿Tu mascota come huesos?'),
        ...
        pregunta('¿Tu mascota se revuelca cuando lo bañas?'),
...
hormiga:-artropodo,
        ...
        pregunta('¿Tu mascota es hervivora/carroñera(se alimenta de lo que encuentra)?').
sana:-anfibio,
